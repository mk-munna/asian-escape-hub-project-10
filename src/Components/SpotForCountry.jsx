        ...
        <div data-aos="fade-up" data-aos-duration="1500" className=''>
            <div className="w-full bg-base-100 shadow-xl  hover:scale-[1.01] duration-500 ">
                <figure className=" relative">
                    ...
                    <span className={`absolute text-sm bg-primary px-2 py-[2px] rounded-md top-3 left-3 text-white font-Montserrat`}>{seasonality}</span>
                    <span className={`absolute text-sm bg-yellow-400 text-black px-2 py-[2px] rounded-md top-12 left-3  font-Montserrat`}>{country_Name}</span>
                ...
                <div className=" p-6 space-y-3">
                    ...
                    <div className='flex'>
                        <p className='flex items-center'>
                            ...
                            <span className=' px-2 py-[2px] text-[12px] font-Outfit rounded-md'>{travel_time}</span>
                        </p>
                        <p className='flex items-center'>
                            <span className='text-primary'><IoPeople /></span>
                            <span className=' px-2 py-[2px] text-[12px] font-Outfit rounded-md'>{totalVisitorsPerYear}</span>
                        </p>
...
SpotForCountry.propTypes = {
    SpotForCountry: PropTypes.object
};
export default SpotForCountry;