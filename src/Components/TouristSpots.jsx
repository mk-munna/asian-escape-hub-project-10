    ...
    return (
        <div id='' className="my-20 max-w-[350px] md:max-w-screen-sm lg:max-w-6xl mx-auto px-8 lg:px-0">
            <div className='' data-aos="fade-up" data-aos-duration="1500">
                <h1 className="md:text-[40px] leading-[60px] text-2xl   lg:w-[800px] mx-auto text-primary font-Montserrat font-bold text-center">Discover And Enjoy Our Featured Tourist Spot Listings</h1>
